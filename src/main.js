...
const siteFooterStatElement = siteFooterElement.querySelector(
    `.footer__statistics`
);

const filmCardsRender = (count, container, template, place) => {
    render(container, template, place);
    let filmsContainerElement = container.querySelector(`.films-list__container`);
